...
public class DataStorage {
    ...
    public DataStorage() {
     ...
     // The public constructor remains available so simple tests can create clean independent storage objects.
    ...
    // Initializes the system, reads data into storage, and continuously monitorsand evaluates patient data.
